...
function turnt(url, options) {
    ...
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var DOptions, GoRequests, headers, cookies, body, res, result, header;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (options["method"] != "GET" && options["method"] != "POST" && options["method"] != "FORM")
                        reject(new Error("Method must be either GET, POST, or FORM."));
